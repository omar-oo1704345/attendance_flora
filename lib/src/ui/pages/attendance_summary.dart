...
import 'package:attendance_flora/src/models/attendance_list.dart';
import 'package:attendance_flora/src/services/fetch_attendance.dart';
    ...
    return TableCalendar(
      ...
      calendarBuilders: CalendarBuilders(
        ...
        markerBuilder: (context, date, events,) {
          ...
          return _buildHolidaysMarker();
        },
      ),
      onDaySelected: (date, events) {
        _selectedDay = date;
        _onDaySelected(date,_selectedEvents);
